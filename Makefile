...
ALL_CFLAGS= $(CFLAGS) -g -w -3 -I libs/extlib -I libs/extc -I libs/neko -I libs/javalib -I libs/ziplib -I libs/swflib -I libs/xml-light -I libs/ttflib -I libs/ilib -I libs/objsize \
	-I libs/parmap/_build -I src -I src/context -I src/generators -I src/macro -I src/optimization -I src/syntax -I src/typing -I src/display
...
LIBS=unix str libs/extlib/extLib libs/xml-light/xml-light libs/swflib/swflib \
	...
	libs/ttflib/ttf libs/ilib/il libs/objsize/objsize libs/parmap/_build/parmap

NATIVE_LIBS=-cclib libs/extc/extc_stubs.o -cclib -Llibs/parmap/_build/  -cclib libs/extc/process_stubs.o -cclib -lz -cclib libs/objsize/c_objsize.o
...
haxe: $(MODULES:%=src/%.$(MODULE_EXT))
	$(COMPILER) -o $(OUTPUT) $(NATIVE_LIBS) $(NATIVE_LIB_FLAG) $(LFLAGS) bigarray.cmxa $(LIBS:=.$(LIB_EXT))   $(MODULES:%=src/%.$(MODULE_EXT))
...
src/generators/gencpp.$(MODULE_EXT): src/typing/abstract.$(MODULE_EXT) src/globals.$(MODULE_EXT) src/context/meta.$(MODULE_EXT) src/path.$(MODULE_EXT) src/typing/type.$(MODULE_EXT) src/syntax/lexer.$(MODULE_EXT) src/context/common.$(MODULE_EXT) src/generators/codegen.$(MODULE_EXT) src/syntax/ast.$(MODULE_EXT) libs/parmap/_build/bytearray.$(MODULE_EXT) libs/parmap/_build/setcore.$(MODULE_EXT) libs/parmap/_build/parmap.$(LIB_EXT)
